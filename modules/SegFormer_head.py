...
from .SegFormer_module import resize
...
class UnetHead(nn.Module):
    ...
    def forward(self, inputs):
        ...
        up4 = self.up4(conv3)
        # merge4 = torch.concat([up2, x3], dim=1)
...
class UNetHeadv2(nn.Module):
    def __init__(self, inchannels, num_classes, channels=1024, interpolate_mode='bilinear', dropout_ratio=0.1):
        super().__init__()
